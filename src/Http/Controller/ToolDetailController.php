...
{
    public function emailAssistant(
        ...
        $html = View::renderToString('tools/email-assistant', [
            ...
            'tool' => [
                ...
                'description' => 'Onze meest geavanceerde email assistent met ondersteuning ' .
                    'voor meerdere talen en integratie met populaire email-clients.',
                'features' => [
    ...
    public function documentAnalyzer(
        ...
        $html = View::renderToString('tools/document-analyzer', [
            ...
            'tool' => [
                ...
                'description' => 'Analyseer contracten en juridische documenten met AI ' .
                    'en krijg direct de belangrijkste punten uitgelicht.',
                'features' => [
                    'Contract analyse',
                    'Risico detectie',
    ...
    public function meetingSummarizer(
        \Psr\Http\Message\ServerRequestInterface $request
    ): \Psr\Http\Message\ResponseInterface {
        $html = View::renderToString('tools/meeting-summarizer', [
            ...
            'tool' => [
                ...
                'description' => 'Automatisch samenvattingen maken van vergaderingen ' .
                    'en belangrijke actiepunten extraheren.',
                'features' => [
