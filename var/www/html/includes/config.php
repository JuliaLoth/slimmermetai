<?php
/**
 * Configuratiebestand voor SlimmerMetAI.com
 */
...
define('ADMIN_EMAIL', 'admin@slimmermetai.com');

// Database configuratie
define('DB_HOST', 'localhost');
define('DB_NAME', 'slimmermetai');
define('DB_USER', 'root');      // Wijzig dit voor productie!
define('DB_PASS', '');          // Wijzig dit voor productie!
...
define('COOKIE_PATH', '/');
define('COOKIE_SECURE', true);  // Zet op false voor lokale ontwikkeling
...
// E-mail instellingen
define('MAIL_FROM', 'noreply@slimmermetai.com');
define('MAIL_FROM_NAME', 'SlimmerMetAI');
define('MAIL_REPLY_TO', 'support@slimmermetai.com');

// Ontwikkelingsinstellingen
define('DEBUG_MODE', true);     // Zet op false voor productie!
define('DISPLAY_ERRORS', true); // Zet op false voor productie!
