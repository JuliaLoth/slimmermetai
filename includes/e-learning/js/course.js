    ...
    if (!isLoggedIn) {
        ...
        loginPrompt.innerHTML = `
            <div class="prompt-container">
                ...
                <a href="/login.php?returnUrl=${encodeURIComponent(window.location.pathname)}" class="btn btn-primary">Inloggen</a>
            </div>
        `;
    ...
    if (!hasPurchased) {
        ...
        purchasePrompt.innerHTML = `
            <div class="prompt-container">
                ...
                <a href="/e-learning/courses.php" class="btn btn-primary">Bekijk beschikbare cursussen</a>
            </div>
        `;
...
function getCourseId() {
    ...
    // Bijvoorbeeld: /e-learning/course-ai-basics.php -> ai-basics
    const path = window.location.pathname;
    const matches = path.match(/course-([a-z0-9-]+)\.php/);
