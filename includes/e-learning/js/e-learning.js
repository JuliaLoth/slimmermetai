...
function checkUserLogin() {
    ...
    if (isSecurePage && !isLoggedIn) {
        ...
        window.location.href = '/login.php?returnUrl=' + returnUrl;
    }
}
        ...
        if (purchasedCourses.length === 0) {
            coursesGrid.innerHTML = `
                <div class="no-courses-message">
                    ...
                    <a href="courses.php" class="btn btn-primary">Bekijk cursussen</a>
                </div>
            `;
            return;
        }
    ...
    return [
        {
            ...
            image: 'img/ai-basics.svg',
            progress: 35,
            url: 'course-ai-basics.php'
        },
        {
            id: 'prompt-engineering',
            title: 'Prompt Engineering',
            description: 'Leer effectieve prompts schrijven voor AI tools en generatieve AI.',
            image: 'img/prompt-engineering.svg',
            progress: 10,
            url: 'course-prompt-engineering.php'
        }
    ];
}
