        ...
        <div class="course-detail-grid">
            <div class="course-detail-main">
                ...
                <div class="course-description">
                    <h2>Transformeer data naar actionable insights</h2>
                    <p>Leer hoe je AI inzet voor data analyse, visualisatie en het maken van voorspellingen die je business vooruit helpen.</p>
