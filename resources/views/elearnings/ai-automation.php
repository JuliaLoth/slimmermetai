        ...
        <div class="course-detail-grid">
            <div class="course-detail-main">
                ...
                <div class="course-description">
                    <h2>Automatiseer je workflow met AI</h2>
                    <p>Ontdek hoe je repetitieve taken kunt automatiseren en uren per week kunt besparen. Deze praktische cursus laat je zien hoe je AI inzet voor workflow automatisering.</p>
