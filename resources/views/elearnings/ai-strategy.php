        ...
        <div class="course-detail-grid">
            <div class="course-detail-main">
                ...
                <div class="course-description">
                    <h2>Ontwikkel een AI-strategie voor je organisatie</h2>
                    <p>Leer hoe je een complete AI-strategie ontwikkelt en implementeert. Van risicomanagement tot change management - alle aspecten komen aan bod.</p>
