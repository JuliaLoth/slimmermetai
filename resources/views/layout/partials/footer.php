        ...
        <div class="footer-content">
            ...
            <div class="footer-column">
                ...
                <ul class="footer-links">
                    <li><a href="/tools#email-tool">Email Assistent</a></li>
                    <li><a href="/tools#rapport-tool">Rapport Generator</a></li>
                    <li><a href="/tools#meeting-tool">Meeting Summarizer</a></li>
            ...
            <div class="footer-column">
                <h4>Cursussen</h4>
                <ul class="footer-links">
                    <li><a href="/e-learnings#basics">AI Basics</a></li>
                    <li><a href="/e-learnings">Alle Cursussen</a></li>
                </ul>
            </div>
